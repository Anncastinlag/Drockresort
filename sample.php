...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO `new_reservation`(`ID`, `GUEST_NAME`, `CONTACT_NO`, `ADULT`, `KID`, `PWD`, `TOTAL_PAX`,`TYPE`,`COTTAGE_TYPE`, `CQUANTITY`, `ROOM_TYPE`, `RQUANTITY`, `EXCLUSIVE_TYPE`, `DATE_RESERVED`, `VALID-ID`) VALUES(NULL,'$GUEST_NAME','$CONTACT_NO','$ADULT','$KID','$PWD','$TOTAL_PAX','$TYPE','$COTTAGE_TYPE','$CQUANTITY','$ROOM_TYPE','$RQUANTITY','$EXCLUSIVE_TYPE','$DATE_RESERVED', '$VALID_ID')";
...
<div class="booking-reserve-info"> 
    ...
    <h2><b>Please provide accurate information.</b></h2> 
      ...
      <input type="text" class="form-control" name="GUEST_NAME" required></label>
    </div>
    ...
    <label for="cpnum">Phone No<span>*</span>:
        ...
        <input type="text" class="input form-control" name="ADULT" placeholder="10" id="adult" required /></label>
        </div>
        </div>
        ...
        <input type="text" class="input form-control" name="KID" id="kid" /> </label><br>
        </div>
      
         <div class="col">
        <label for="cpnum">PWD/ Person with disability: <br>
        <input type="text" class="input form-control" name="PWD" id="pwd"></label>  
        </div>

        <div class="col">
        <label for="cpnum"> Total: <br>
        <input type="text" class="form-control" name="TOTAL_PAX" id="total"></label>  
        </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <select name="TYPE"  class="form-control" id="cot" required>
            ...
            <label>Cottage Type: <br> 
              <select name="COTTAGE_TYPE" class="form-control" id="cot" required>
                <option value="" selected hidden>Select</option>
                <option value="NIPA ROCK 1">NIPA ROCK 1 8-10 Persons </option>
                <option value="NIPA ROCK 2">NIPA ROCK 2 8-10 Persons </option>
                <option value="NIPA ROCK 3">NIPA ROCK 3 8-10 Persons </option>
                <option value="NIPA ROCK 4">NIPA ROCK 4 15-20 Persons</option>
                <option value="PAVILLION 1">PAVILLION 1 10-15 Persons</option>
                <option value="PAVILLION 2">PAVILLION 2 10-15 Persons</option>
                <option value="PAVILLION 3">PAVILLION 3 10-15 Persons</option>
                <option value="PAVILLION 4">PAVILLION 4 10-15 Persons</option>
                <option value="VIEW DECK 1">VIEW DECK 1 10-15 Persons</option>
                <option value="VIEW DECK 2">VIEW DECK 2 10-15 Persons</option>
                <option value="VIEW DECK 3">VIEW DECK 3 10-15 Persons</option>
                <option value="VIEW DECK 4">VIEW DECK 4 10-15 Persons</option>
              </select>
              </label>
              </div>
          ...
          <div class="col">
            ...
            <input type="number" class="form-control" id="cot"  name="CQUANTITY" id="a" placeholder="1" min="1" max="4" required /></label>
            </div>
            </div>
       <div class="payment">
...
<script src="jquery-3.5.0.min.js"></script>
	<script>
    	...
    	$("#adult, #kid, #pwd").keyup(function(){

    	var total=0;    	
    	var x = Number($("#adult").val());
    	var y = Number($("#kid").val());
	   	var w = Number($("#pwd").val());
    	var total=x + y + w;  
