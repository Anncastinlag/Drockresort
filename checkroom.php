...
<div class="booking-reserve-info"> 
    ...
    <label for="cpnum">Phone No<span>*</span>:
        ...
        <input type="text" class="input form-control" name="ADULT" placeholder="1" id="adult" max="1" required /></label>
        </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <input type="number" class="form-control" id="cot"  name="RQUANTITY" id="a" placeholder="1" max="4" required /></label>
            </div>
            </div>
