...
if(isset($_POST['submit'])){
    ...
    if(file_exists("upload/".$_FILES["IMAGES"]["name"]))
    {
      ...
      $query = "INSERT INTO `available`(`IMAGES`,`COTTAGE_TYPE`,`DESCRIPTION`, `SCHED_TIME`, `PRICE`) VALUES ('$IMAGES','$COTTAGE_TYPE ','$DESCRIPTION','$SCHED_TIME','$PRICE')";
      ...
      if($query_run) {
        ...
        $_SESSION['error'] ="Available Services Not Added";   
        header('Location: check.php?');
      }
    }
