...
<!-- 
   ...
   {
    $query = "SELECT * FROM `check_exclusive` ";
    ...
    while($row = mysqli_fetch_array($query_run))
    {
       ...
       <div class="cardss">
        <div class="avail-cot">
       <?php echo $row['EXCLUSVE']?>
        </div>
        <div class="avail-des">
        <?php echo $row['DESCRIPTION']?><br>
          </div>
          <div class="avail-ser">
            <?php echo $row['SCHED_DAYTIME']?>
          </div>
          <div class="avail-ser">
            <?php echo $row['SCHED_NIGHTIME']?>
          </div>
          <div class="avail-ser">
          <?php echo $row['DAYTIME_PRICE']?>
          </div> 
          <div class="avail-ser">
          <?php echo $row['NIGHTIME_PRICE']?>
          </div>
          <div class="avail-ser">
