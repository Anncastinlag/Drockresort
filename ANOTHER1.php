...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `check_cottage`(`IMAGES`,`COTTAGE_TYPE`,`DESCRIPTION`,`SCHED_DAYTIME`,`SCHED_NIGHTIME`, `PRICE`) VALUES ('$file','$COTTAGE_TYPE','$DESCRIPTION','$SCHED_DAYTIME','$SCHED_NIGHTIME','$PRICE')";
...
<div class="booking-reserve-info"> 
    ...
    <h2><b>Please provide accurate information.</b></h2> 
      <p>D'rock Pool Form</p> 
       ...
       <div class="row">
       <div class="col">
      <label for="">PLEASE ATTACH COTTAGE:
      <input type="file" class="form-control" name="IMAGES" accept=".jpg, .jpeg, .png" required></label>
    </div>
        </div>
        <div class="col">
            <label>Cottage Type: <br> 
              ...
              <option value="View Deck  1 10-15 Persons">View Deck  10-15 Persons</option>
              <option value="Nipa 2 Rock 8-10 Persons">Nipa Rock  8-10 Persons</option>
              <option value="Pavillion 1 15-20 Person">Pavillion  15-20 Persons</option>
              </select>
              </label>
              </div>
        ...
        <div class="row">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="" name="Night Time" id="flexCheckChecked" checked>
            <label class="form-check-label" for="flexCheckChecked">
             Area 2
            </label>
            </div>
...
<div class="form-check form-check-inline">
  <h1>Price</h1>
  <input class="form-check-input" type="radio" name="PRICE" id="inlineRadio1" value="&#8369;2,000">
  <label class="form-check-label" for="inlineRadio1">&#8369;2,000</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="PRICE" id="inlineRadio2" value="&#8369;2,100">
  <label class="form-check-label" for="inlineRadio2">&#8369;2,000</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="PRICE" id="inlineRadio3" value="&#8369;2,200">
  <label class="form-check-label" for="inlineRadio3">&#8369;2,000</label>
</div>
