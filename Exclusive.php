...
<div class="booking-reserve-info"> 
    ...
    <label for="cpnum">Phone No<span>*</span>:
        ...
        <input type="number" class="form-control" name="ADULT" placeholder="20" id="cot" min="5" required required /></label>
        </div>
        </div>
        ...
        <input type="number" class="form-control" name="KID" placeholder="20" /> </label><br>
        </div>
        ...
        <div class="cottage-reserve">
          <h2>D'rock Exclusive</h2><br> 
        </div>

        <div class="row">
          <div class="col">
            <label>Day Time Schedule<span>*</span>: <br> 
            <select name="EXCLUSIVE_SCHED"  class="form-control" id="cot" required>
            ...
            <div class="col">
            <label>Exclusive Type: <br> 
              <select name="EXCLUSIVE_TYPE" class="form-control" id="cot" required>
                <option value="" selected hidden>Select</option>
                <option value="PUBLIC">	PUBLIC_AREA_DAY</option>
                <option value="PRIVATE">PUBLIC_AREA_NIGHT</option>
                <option value="PAVILLION">PRIVATE_DAY</option>
                <option value="PAVILLION">PRIVATE_NIGHT</option>
