...
<div class="booking-reserve-info"> 
    ...
    <label for="cpnum">Phone No<span>*</span>:
        ...
        <input type="number" class="form-control" name="ADULT" placeholder="10" id="cot" min="5" required max="10" required /></label>
        </div>
        </div>
        ...
        <input type="number" class="form-control" name="KID" placeholder="10" min="5" max="10" /> </label><br>
        </div>
      
         <div class="col">
        <label for="cpnum">PWD/ Person with disability: <br>
        <input type="number" class="form-control" name="PWD" id="cot"></label>  
        </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="col">
            <label>Room Type: <br> 
              <select name="ROOM_TYPE" class="form-control" id="cot" required>
                <option value="" selected hidden>Select</option>
                <option value="1BED ROOM1">1BED ROOM 1</option>
                <option value="1BED ROOM2">1BED ROOM 2</option>
                <option value="1BED ROOM3">1BED ROOM 3</option>
                <option value="1BED ROOM4">1BED ROOM 4</option>
                <option value="1BED ROOM5">1BED ROOM 5</option>
                <option value="2BED ROOM1">2 BED ROOM 1</option>
                <option value="2BED W/O COMFORT">2BED W/O COMFORT</option>
              </select>
              </label>
              </div>
          ...
          <div class="col">
            ...
            <input type="number" class="form-control" id="cot"  name="RQUANTITY" id="a" placeholder="1" min="1" max="4" required /></label>
            </div>
            </div>

        <input type="file" name="VALID_ID" class="form-control" accept="image/*" required><br><br>
        <div class="payment">
