...
if(isset($_POST['submit'])){
    ...
    $EXCLUSIVE_SCHED = $_POST['EXCLUSIVE_SCHED'];
    $VALID_ID = $_POST['VALID_ID'];

    $sql = "INSERT INTO `online_reserve`(`ID`, `GUEST_NAME`, `CONTACT_NO`, `ADULT`, `KID`, `PWD`, `TYPE`, `COTTAGE_TYPE`, `CQUANTITY`, `ROOM_TYPE`, `RQUANTITY`, `EXCLUSIVE_TYPE`, `EXCLUSIVE_SCHED`, `DATE_RESERVED`, `FUNCTIONAL_HALL`, `VALID_ID`) VALUES (NULL,'$GUEST_NAME ','$CONTACT_NO','$ADULT','$KID','$PWD',' $TYPE','$COTTAGE_TYPE',' $CQUANTITY','$ROOM_TYPE','$RQUANTITY','$EXCLUSIVE_TYPE','$EXCLUSIVE_SCHED','$DATE_RESERVED', '$FUNCTIONAL_HALL', '$VALID_ID')";
...
<div class="booking-reserve-info"> 
    ...
    <label for="cpnum">Phone No<span>*</span>:
        ...
        <input type="number" class="form-control" placeholder="1" name="ADULT" id="cot" required></label>
        </div>
        </div>
        ...
        <input type="number" class="form-control" placeholder="1" name="KID" required></label><br>
        </div>

        <div class="row">
          <div class="col">
            <label>Day Time Schedule<span>*</span>: <br> 
            <select name="TYPE"  class="form-control" id="cot">
        ...
        <input type="date" class="form-control" name="DATE_RESERVED" id="checkin-date" min="12-25-2022" required></label>
          ...
          <div class="col">
        <label>Room Type: <br>
        <select name="ROOM_TYPE" class="form-control" id="cot">
          <option value="" selected hidden>Select</option>
        ...
        <div class="col">
        <label>Room Quantity:
        <input type="number" class="form-control" name="RQUANTITY" id="a">
      </label>
        </div>
